...
use super::{service::ShutdownToken, woccy};
...
//     for path in paths {
//         for result in woccy::WalkDir::new(path) {
...
impl FileSystem {
    ...
    pub fn dump(&self) -> Result<()> {
        ...
        std::fs::write("record.bin", serialized)?;
        Ok(())
    }
}
...
impl Indexer {
    pub fn new(shutdown_rx: async_broadcast::Receiver<ShutdownToken>) -> Self {
        Self { shutdown_rx }
    }
